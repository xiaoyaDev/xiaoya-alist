...
安装 CasaOS -> 6 7 1
安装 小雅元数据定时爬虫 -> 2 5 1
安装 Xiaoya Proxy -> 6 4 1
安装 Xiaoya aliyuntvtoken_connector -> 6 5 1
——————————————————————————————Emby手动全家桶配置————————————————————————————————————
...
更新 小雅元数据定时爬虫 -> 2 5 2
更新 Xiaoya Proxy -> 6 4 2
更新 Xiaoya aliyuntvtoken_connector -> 6 5 1
———————————————————————————————————————卸载———————————————————————————————————————
卸载 小雅Alist -> 1 3
卸载 Emby全家桶 -> 2 7
...
卸载 CasaOS -> 6 7 2
卸载 小雅元数据定时爬虫 -> 2 5 3
卸载 Xiaoya Proxy -> 6 4 3
卸载 Xiaoya aliyuntvtoken_connector -> 6 5 1
————————————————————————————————Docker Compose—————————————————————————————————————
安装 小雅及全家桶 -> 6 9 1
卸载 小雅及全家桶 -> 6 9 2
——————————————————————————————————————系统工具——————————————————————————————————————
...
```shell
———————————————————————————————————————安装———————————————————————————————————————
安装 Jellyfin全家桶（一键） -> 7 8 3 1
安装 Resilio-Sync（单独） -> 7 8 2 2 1
——————————————————————————————Emby手动全家桶配置————————————————————————————————————
立即 同步小雅Emby的config目录 -> 7 8 2 3
单独 创建/删除 同步定时更新任务 -> 7 8 2 4
————————————————————————————Jellyfin手动全家桶配置——————————————————————————————————
...
单独 下载并解压 全部元数据 -> 7 8 3 2 1
单独 解压 全部元数据 -> 7 8 3 2 2
单独 下载 all_jf.mp4 -> 7 8 3 2 3
单独 解压 all_jf.mp4 -> 7 8 3 2 4
解压 all_jf.mp4 的指定元数据目录【非全部解压】-> 7 8 3 2 5
单独 下载 config_jf.mp4 -> 7 8 3 2 6
单独 解压 config_jf.mp4 -> 7 8 3 2 7
单独 下载 PikPak_jf.mp4 -> 7 8 3 2 8
单独 解压 PikPak_jf.mp4 -> 7 8 3 2 9
选择 下载器【aria2/wget】-> 7 8 3 2 10
单独 安装Jellyfin-> 7 8 3 3
———————————————————————————————————————更新———————————————————————————————————————
更新 Resilio-Sync（单独） -> 7 8 2 2 2（已弃用）
———————————————————————————————————————卸载———————————————————————————————————————
卸载 卸载Jellyfin全家桶 -> 7 8 3 4（已弃用）
卸载 Resilio-Sync（单独） -> 7 8 2 2 3（已弃用）
———————————————————————————————————————其他———————————————————————————————————————
创建/删除 定时同步更新数据（小雅alist启动时拉取的数据）-> 7 8 1 1
```
